...
class Ui():
  def __init__(self, main_window):
    ...
    button_disable   = self.main_window.findChild(QtWidgets.QPushButton, 'PushButton_controlDisable')
    button_auto      = self.main_window.findChild(QtWidgets.QPushButton, 'PushButton_controlAuto')
    # button_manual_fw = self.main_window.findChild(QtWidgets.QPushButton, 'PushButton_controlManualFW')
    # button_manual_bw = self.main_window.findChild(QtWidgets.QPushButton, 'PushButton_controlManualBW')
